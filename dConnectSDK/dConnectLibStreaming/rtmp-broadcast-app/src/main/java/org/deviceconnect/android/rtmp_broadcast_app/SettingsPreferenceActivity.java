...
public class SettingsPreferenceActivity extends AppCompatActivity {
    ...
    public static class RtspPreferenceFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
            setPreferencesFromResource(R.xml.rtmp_client_settings, rootKey);

            Context context = getContext();
            if (context != null) {
                mSettings = new Settings(context);
                createBroadcastUriPreference();
                createCameraSettingsPreference(context);
                createEncoderFrameRatePreference();
                createEncoderBitratePreference();
                createEncoderIFrameIntervalPreference();
            }

            setInputTypeNumber("encoder_frame_rate");
            setInputTypeNumber("encoder_i_frame_interval");
            setInputTypeNumber("encoder_bitrate");
            setInputTypeNumber("audio_bitrate");
        }
        ...
        private void createBroadcastUriPreference() {
//            EditTextPreference pref = findPreference("broadcast_uri");
//            if (pref != null) {
//                pref.setText("rtmp://" + getIpAddress() + ":12345");
//            }
        }
        ...
        private void createEncoderBitratePreference() {
            ...
            if (pref != null) {
                ...
                String value = pref.getText();
                if (value == null) {
                    pref.setText(Settings.DEFAULT_ENCODER_BITRATE);
                }
            }
        }

        private void createEncoderIFrameIntervalPreference() {
            ...
            if (pref != null) {
                ...
                String value = pref.getText();
                if (value == null) {
                    pref.setText(Settings.DEFAULT_ENCODER_I_FRAME_INTERVAL);
                }
            }
        }
