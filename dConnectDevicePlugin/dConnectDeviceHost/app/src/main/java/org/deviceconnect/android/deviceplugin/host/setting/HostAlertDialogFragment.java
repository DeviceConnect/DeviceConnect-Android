 ...
 */
public class HostAlertDialogFragment extends DialogFragment {
    /**
     * タグのキーを定義します.
     */
     ...
     */
    public static HostAlertDialogFragment create(final String tag, final String title, final String message) {
     ...
     * @return AlertDialogFragmentのインスタンス
     */
    public static HostAlertDialogFragment create(final String tag, final String title,
     ...
     * @return AlertDialogFragmentのインスタンス
     */
    public static HostAlertDialogFragment create(final String tag,
        ...
        HostAlertDialogFragment dialog = new HostAlertDialogFragment();
