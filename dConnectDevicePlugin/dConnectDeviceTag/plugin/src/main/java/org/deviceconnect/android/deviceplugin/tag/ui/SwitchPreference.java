 ...
 */
package org.deviceconnect.android.deviceplugin.tag.ui;
...
/**
 * SwitchPreference のラッパークラス.
 *
 * <p>
 * SwitchPreference が画面外にスクロールされてしまうと表示が初期化されてしまうので、
 * このラッパークラスで、初期化されないように状態を保持する修正を行います。
 * </p>
 *
