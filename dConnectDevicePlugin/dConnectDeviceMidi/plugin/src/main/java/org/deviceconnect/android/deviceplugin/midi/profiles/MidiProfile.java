...
public class MidiProfile extends BaseMidiProfile {
    ...
    public MidiProfile() {
        ...
        addApi(new GetApi() {
            ...
            public boolean onRequest(final Intent request, final Intent response) {
                ...
                root.putString("protocol", "test");
                root.putString("manifacturer", "test");
                root.putString("productName", "test");
                root.putString("direction", "input");
