...
public abstract class AbstractClientManager implements ClientManager {
    ...
    public Client createClient(PackageInfoOAuth packageInfo, ClientType clientType, String[] redirectURIs,
        ...
        return createClient(packageInfo, clientId, clientSecret, clientType, redirectURIs,
                properties);
    }

    protected abstract Client createClient(PackageInfoOAuth packageInfo, String clientId,
