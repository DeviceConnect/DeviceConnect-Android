...
public class HttpUtils {
    ...
    public static Response connect(String method, String uri, Map<String, String> headers, String body) {
        if (DEBUG) {
    ...
    public static Response post(final String uri, final String body) {
