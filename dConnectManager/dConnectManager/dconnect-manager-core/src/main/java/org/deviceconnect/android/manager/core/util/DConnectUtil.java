...
public final class DConnectUtil {
    ...
    /**
     * Gets the ip address.
<<<<<<< HEAD:dConnectManager/dConnectManager/app/src/main/java/org/deviceconnect/android/manager/util/DConnectUtil.java
=======
     *
     * @param context Context of application
>>>>>>> master:dConnectManager/dConnectManager/dconnect-manager-core/src/main/java/org/deviceconnect/android/manager/core/util/DConnectUtil.java
     ...
     * <p>
     * Android M 以前の OS では、常にtrueを返却します。
     * </p>
     *
     * @param context コンテキスト
