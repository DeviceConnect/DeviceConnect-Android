 ...
 */
public class DConnectLocalHelper {

    /** デバッグフラグ. */
    private static final boolean DEBUG = true;
    /** デバッグタグ. */
    private static final String TAG = "DConnectLocalHelper";

    /** シングルトンなManagerのインスタンス. */
    public static final DConnectLocalHelper INSTANCE = new DConnectLocalHelper();
