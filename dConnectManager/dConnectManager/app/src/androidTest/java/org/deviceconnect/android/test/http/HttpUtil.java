...
public final class HttpUtil {
     ...
     * @return HTTPサーバのレスポンス
     */
    public static byte[] put(final String uri, final String body) {
        return connect(METHOD_PUT, uri, null, body);
    }
     ...
     * @return HTTPサーバのレスポンス
     */
    public static byte[] post(final String uri, final String body) {
