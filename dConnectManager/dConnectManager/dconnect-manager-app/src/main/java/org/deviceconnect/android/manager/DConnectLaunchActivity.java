...
public class DConnectLaunchActivity extends AppCompatActivity {
    ...
    private void toggleButton(final boolean isLaunched) {
        ...
        TextView messageView = findViewById(R.id.text_manager_launcher_message);
        Button launchOrStopButton = findViewById(R.id.button_manager_launcher_launch_or_stop);
        ...
        if (isLaunched) {
            ...
            launchOrStopButton.setOnClickListener((v) -> {
                stopManager();
                setResult(RESULT_OK);
                finish();
            });
