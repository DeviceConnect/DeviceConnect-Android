...
public final class HttpUtil {
     ...
     * @return レスポンス
     */
    public static Response get(final String uri, final Map<String, String> headers) {
        return connect(METHOD_GET, uri, headers, null, false);
    }

    /**
     * PUTメソッドで通信を行いレスポンスを取得する.
     * @param uri 接続先のURI
     * @return レスポンス
     */
    public static Response put(final String uri) {
        return put(uri, null);
    }
     ...
     * @return レスポンス
     */
    public static Response put(final String uri, final Map<String, String> headers) {
     ...
     * @return レスポンス
     */
    public static Response put(final String uri, final Map<String, String> headers, final Object body) {
        return connect(METHOD_PUT, uri, headers, body, false);
    }
     ...
     * @return レスポンス
     */
    public static Response post(final String uri, final Map<String, String> headers) {
     ...
     * @return レスポンス
     */
    public static Response post(final String uri, Map<String, String> headers, final Object body) {
        return connect(METHOD_POST, uri, headers, body, false);
    }
     ...
     * @return レスポンス
     */
    public static Response delete(final String uri, final Map<String, String> headers) {
        return connect(METHOD_DELETE, uri, headers, null, false);
    }
