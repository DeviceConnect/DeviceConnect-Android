...
The build will require a GitHub account and a token.
Follow these steps to set up a GitHub account and token in your project.

1. In GitHub, go to Settings > Developer settings > Personal access tokens.
2. The scope should be generated by checking the `repo`, `write:packages` and `read:packages` boxes.
3. Create and place a file called `github.properties` in the root directory of your project.
4. Enter your username and token in github.properties.
