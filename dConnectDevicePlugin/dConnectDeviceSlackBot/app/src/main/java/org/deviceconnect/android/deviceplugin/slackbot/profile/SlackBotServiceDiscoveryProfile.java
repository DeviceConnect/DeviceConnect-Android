/*
SlackBotServceDiscoveryProfile
 ...
 * @author docomo
 */
public class SlackBotServiceDiscoveryProfile extends ServiceDiscoveryProfile {

    /** サービスID. */
    public static final String SERVICE_ID = "slackbot_service_id";

    /** デバイス名. */
    private static final String DEVICE_NAME = "Slack Device";

    public SlackBotServiceDiscoveryProfile(DConnectProfileProvider provider) {
        super(provider);
    }
